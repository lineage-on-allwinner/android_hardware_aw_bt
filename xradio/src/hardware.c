...
#define NEED_HCI_RESET                          0
#define NEED_CHANGE_BAUDRATE                    1
#define NEED_READ_NAME                          0
...
#if defined (NEED_CHANGE_BAUDRATE) && (NEED_CHANGE_BAUDRATE)
                UINT16_TO_STREAM(p, HCI_VSC_UPDATE_BAUDRATE);
...
#if defined (NEED_READ_NAME) && (NEED_READ_NAME)
...
{
#if defined (NEED_HCI_RESET) && (NEED_HCI_RESET)
    HC_BT_HDR  *p_buf = NULL;
    uint8_t    *p;
